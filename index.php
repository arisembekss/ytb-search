...
if ($_GET['q'] && $_GET['maxResults']) {  
  ...
  require_once ($_SERVER["DOCUMENT_ROOT"].'/gitbuku/google-api-php-client/src/Google_Client.php');  
  require_once ($_SERVER["DOCUMENT_ROOT"].'/gitbuku/google-api-php-client/src/contrib/Google_YouTubeService.php');  
  
  /* Set $DEVELOPER_KEY to the "API key" value from the "Access" tab of the 
  Google APIs Console <http://code.google.com/apis/console#access> 
  Please ensure that you have enabled the YouTube Data API for your project. */  
  $DEVELOPER_KEY = 'AIzaSyAo4GpRQ9uQvvCKgf6ZGL0-PSH8OU-V0vY';  
  ...
  try {  
    ...
    $videos = '';  
    $channels = '';  
    echo json_encode(array('result'=>$searchResponse));
